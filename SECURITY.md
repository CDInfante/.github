...
The Clube Desportivo Infante Dom Henrique takes the security of our software products and services seriously, which includes all source code repositories managed through our [GitHub organization](https://github.com/CDInfante).

## Reporting Security Issues

If you believe you have found a security vulnerability in any of Clube Desportivo Infante Dom Henrique owned repositories, please report it to us through coordinated disclosure.

**Please do not report security vulnerabilities through public GitHub issues, discussions, or pull requests.**

Instead, please send an email to `security [at] cdinfante [dot] org`.
